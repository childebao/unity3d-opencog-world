...
{	
	...
	/// <summary>
	/// The height of the reflective surface.
	/// </summary>
	...
	/// <summary>
	/// The initial reflection textures.
	/// </summary>
	...
	{		
		...
		Debug.Log ("Fallaçade: created internal reflection camera " + reflName);
